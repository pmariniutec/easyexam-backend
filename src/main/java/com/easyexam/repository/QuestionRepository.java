...
public interface QuestionRepository extends JpaRepository<Question, Long> {
	...
	@Query(value = "SELECT question_id as id, content, created, updated FROM questions NATURAL JOIN (SELECT * FROM keywords K WHERE K.keywords IN :selected_keywords ) as K ORDER BY RANDOM() LIMIT :n", nativeQuery = true)
